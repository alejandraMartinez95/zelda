...
var vidasBoss=5;
var espadaSound = new Audio();
espadaSound.src = 'sound/sword3.mp3';

var ghostSound = new Audio();
ghostSound.src = 'sound/demon_death.mp3';

var ojoSound = new Audio();
ojoSound.src = 'sound/zombie_say.mp3';

var aranaSound = new Audio();
aranaSound.src = 'sound/spider_death.mp3';

var bossSound = new Audio();
bossSound.src = 'sound/demon2.mp3';

var musica = new Audio();
musica.src = 'sound/musica.mp3';
...
var setup = function(){
	...
	derrota=loadImage('img/Escenario/lost.png')
	bg=loadImage('img/Escenario/bg.jpg');
	pino=loadImage('img/Escenario/pino.png');
	block=loadImage('img/Escenario/block.png');
	agua=loadImage('img/Escenario/agua.png');
	pasto=loadImage('img/Escenario/pasto.png');
	pastoa=loadImage('img/Escenario/pastona.png');
	piedra2=loadImage('img/Escenario/pared.jpg');///
	pared=loadImage('img/Escenario/pared2.png');
	ojo=loadImage('img/Escenario/ojo.png');
	ghost=loadImage('img/Escenario/ghost.png');
	arana=loadImage('img/Escenario/ara.png');
	blockBoss=loadImage('img/Escenario/mario.jpg');
	///lava
	///lava
		lava=loadImage('img/Escenario/lava.jpg');
		pared_4=loadImage('img/Escenario/pared_4.png');
		puerta=loadImage('img/Escenario/puerta.png');
	...
	for(var i =0; i<linea; i++){
		for(var j=0; j<colum; j++){
			...
			switch(auxNivel[i][j]){
				...
				break;
				case 5:
					image(block,pox,poy,40,40);
				break;
				case 7:
					image(ojo,pox,poy,40,40);
					ojoSound.play();
				break;
